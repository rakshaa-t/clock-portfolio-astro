...
export const MMIND_CARDS=[
  ...
  },
  {
    ...
    source:'studio.accurat.it', url:'https://studio.accurat.it',
    tldr:'Data-driven design studio  - data visualization, information design, and data art.',
    tags:['Inspiration'], category:'inspiration', date:'today'
  },
  {
    type:'image', img:'/mymind/beauty-of-math.jpg', height:95,
    caption:'Beauty of Mathematics',
    title:'Beauty of Mathematics',
    source:'vimeo.com', url:'https://vimeo.com/77330591',
    tldr:'Short film revealing the beauty of mathematics in nature, architecture, and patterns.',
    tags:['Inspiration'], category:'inspiration', date:'today'
  },
  {
    type:'image', img:'/mymind/design-strategies.png', height:90,
    caption:'Design Strategies',
    title:'Design Strategies',
    source:'getdesignstrategies.com', url:'https://getdesignstrategies.com/',
    tldr:'Actionable design strategy cards and frameworks for product designers.',
    tags:['Tools','UI Design'], category:'tools', date:'today'
  },
  {
    type:'image', img:'/mymind/codesandbox-devtools.jpg', height:90,
    caption:'DevTools  - CodeSandbox',
    title:'CodeSandbox DevTools',
    source:'codesandbox.io', url:'https://codesandbox.io/docs/learn/vm-sandboxes/devtools',
    tldr:'Browser devtools integration for CodeSandbox VM sandboxes.',
    tags:['Tools'], category:'tools', date:'today'
  },
  {
    type:'image', img:'/mymind/rebrand.jpg', height:95,
    caption:'Rebrand  - Stellar visual identity inspiration',
    title:'Rebrand',
    source:'rebrand.gallery', url:'https://rebrand.gallery',
    tldr:'Curated visual identity inspiration  - stellar branding and logo redesigns.',
    tags:['Inspiration'], category:'inspiration', date:'today'
  },
  {
    type:'image', img:'/mymind/symbl-logo.png', height:95,
    caption:'Symbl  - Test your logo before the world does',
    title:'Symbl Logo Tester',
    source:'symbl.cc', url:'https://symbl.cc',
    tldr:'Preview and stress-test your logo across real-world contexts before launch.',
    tags:['Tools'], category:'tools', date:'today'
  },
  {
    type:'image', img:'/mymind/design-spells.png', height:100,
    caption:'Mobile spells \u00B7 Design Spells',
    title:'Design Spells  - Mobile',
    source:'designspells.com', url:'https://designspells.com',
    tldr:'Curated collection of real-world mobile design patterns and micro-interactions.',
    tags:['UI Design','Inspiration'], category:'ui design', date:'today'
  },
  {
    type:'image', img:'/mymind/locale-puckett.png', height:85,
    caption:'Locale | Josh Puckett',
    title:'Locale  - Josh Puckett',
    source:'joshuapuckett.com', url:'https://joshuapuckett.com',
    tldr:'Josh Puckett\u2019s Locale project  - design engineering work.',
    tags:['Inspiration'], category:'inspiration', date:'today'
  },
  {
