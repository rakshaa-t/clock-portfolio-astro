...
export const NOTES=[
  ...
  },
  {
    ...
    body:[
      ...
      {type:"text",html:`<p style="margin-top:36px"><strong>Motion Gestures</strong><br><span style="color:rgba(0,0,0,0.4)">whileHover, whileTap, whileDrag, onPan, whileFocus, whileInView — spring-first gesture patterns for React. Based on Jakub Krehel's article.</span></p>`},
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
      ...
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
      {type:"text",html:`<p style="margin-top:36px"><strong>Gradients</strong><br><span style="color:rgba(0,0,0,0.4)">Linear, radial, conic, diamond — color spaces (oklch vs sRGB), color hints, layering with blend modes, GPU-safe animation. Based on Jakub Krehel's article.</span></p>`},
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
      ...
      {type:"text",html:`<p style="margin-top:36px"><strong>Animation Rules</strong><br><span style="color:rgba(0,0,0,0.4)">Comprehensive UI animation guidelines — timing, easing, performance, accessibility, springs, gestures</span></p>`},
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
      {type:"text",html:`<p style="margin-top:28px"><em>UI/UX Design (13)</em></p>`},
      ...
      {type:"text",html:`<p style="margin-top:36px"><strong>Interface Craft</strong><br><span style="color:rgba(0,0,0,0.4)">Storyboard animation DSL, DialKit live controls, design critique — by Josh Puckett</span></p>`},
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
      {type:"text",html:`<p style="margin-top:36px"><strong>UI Questionnaire</strong><br><span style="color:rgba(0,0,0,0.4)">Ask detailed questions before implementing UI — visual, typography, animations, states, accessibility</span></p>`},
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
      {type:"text",html:`<p style="margin-top:36px"><strong>Rams</strong><br><span style="color:rgba(0,0,0,0.4)">Run accessibility and visual design review</span></p>`},
      {type:"code",html:`<span class="cm"># Custom skill, ~/.claude/skills/</span>`},
