...
export const NOTES=[
  ...
  },
  {
    ...
    date:"Last updated 1 April 2026",sortDate:20260401,
    tags:["ai","workflow","tools"],
    preview:"47 skills, 5 MCP servers. Every skill I use with Claude Code...",
    rich:true,
    body:[
      {type:"text",html:`<p><strong>47 installed skills</strong></p>`},
      {type:"text",html:`<p><em>Animation & Motion (12)</em></p>`},
